        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <h1><span class="glyphicon glyphicon-user"></span> Web Development</h1>
                    <p>
<span class="glyphicon glyphicon-envelope"></span> Email: sales@xpertevents.com<br>
                        <span class="glyphicon glyphicon-phone"></span> Mobile: (+44)0000000000
                    </p>
                </div>
                <div class="col-md-6">
                    <form method="post">
