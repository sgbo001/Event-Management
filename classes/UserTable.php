...
class UserTable {
    ...
    public function insert($user) {
        ...
        $sql = "INSERT INTO users(fname, lname, email, phoneNo, username, password, role) "
             . "VALUES (:fname, :lname, :email, :phoneNo, :username, :password, :role)";
    ...
    public function getUserById($id) {
        ...
        if ($stmt->rowCount() == 1) {
            ...
            $pwd = $row['password'];
            $role = $row['role'];
            $user = new User($fname, $lname, $email, $phoneNo, $id, $username, $pwd, $role);
        }
        return $user;
    }
