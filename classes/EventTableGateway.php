...
class EventTableGateway {
    ...
    public function getEventsById($id) {
        ...
        $sqlQuery = "SELECT e.EventID, e.Title, e.Description, e.StartDate,e.EndDate,e.Cost, e.LocationID, l.Name FROM events As e INNER JOIN locations l ON e.LocationID=l.LocationID WHERE e.EventID=:id";
